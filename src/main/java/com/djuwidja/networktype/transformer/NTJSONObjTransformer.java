...
/**
 * Transform a {@link JSONObject} into {@link NTDict}.
 * @author kennethdjuwidja
 * @since 1.0.0
 * @version 1.0.0
 */
public class NTJSONObjTransformer implements NTTransformer {
	@Override
	public NTObject transform(Object data) throws IllegalAccessException {
		...
		for (String key : keySet) {
			...
			try {
				NTTransformer transformer = classMapper.getTransformer(value.getClass());
