...
import com.djuwidja.networktype.KeyNotFoundException;
import com.djuwidja.networktype.NTDict;
import com.djuwidja.networktype.NTNull;
import com.djuwidja.networktype.NTObject;

class NTObjectTransformerInternal {
	private static NTObjectTransformerInternal instance = null;
	/**
	 * Get the instance of this singleton object.
	 * @return {@link NTObjectTransformerInternal} the instance.
	 */
	public static NTObjectTransformerInternal getInstance() {
		if (instance == null)
			instance = new NTObjectTransformerInternal();
	 ...
	 */
	private NTObjectTransformerInternal() {
