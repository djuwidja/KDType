...
/**
 * Transform a {@link List} into MQList.
 * @author kennethdjuwidja
 * @since 1.0.0
 * @version 1.0.0
 */
public class MQListTransformerList implements MQTypeTransformer {
	...
	public NTObject transform(Object data) throws IllegalAccessException {
		...
		try {
	        ...
	        if (dataList.size() > 0){
	            ...
	            MQTypeTransformer transformer = classMapper.getTransformer(firstObj.getClass());
	            if (transformer != null) {
